...
import { TextMatch } from '@jsonos/redact-core';
...
export function createProjectReportWebview(
  extensionUri: vscode.Uri,
  results: FileScanResult[],
  onConfirm: (selectedUris: vscode.Uri[]) => Promise<void>
): void {
  const panel = vscode.window.createWebviewPanel(
    'jsonosRedactReport',
    'JSON OS Redact — Project Scan Report',
...
function getWebviewContent(results: FileScanResult[], totalMatches: number): string {
